    ...
    if not pc:
        ...
        if pawn:
            ...
            for sk in sk_comps:
                ...
                # Check FPCamera socket at runtime (with animation)
                if sk.does_socket_exist('FPCamera'):
                    ...
                    print(f'  FPCamera (COMPONENT): Loc={t2.translation}, Rot={t2.rotation.rotator()}')
            ...
            for comp in all_comps:
                ...
                if 'FirstPersonCamera' in cname:
                    ...
                    # Read key properties via reflection
                    for prop_name in ['Camera', 'Mesh', 'OwnerAnimInstance', 'OwnerCharacter']:
                        try:
                            val = comp.get_editor_property(prop_name.lower())
                            if val:
            ...
            print(f'Pawn WorldLoc: {pawn.get_actor_location()}')
            print(f'Pawn WorldRot: {pawn.get_actor_rotation()}')
